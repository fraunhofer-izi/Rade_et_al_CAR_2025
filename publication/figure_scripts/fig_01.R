...
sheet = "Suppl_Table_1"
xlsx.filename = "publication/supplementary_info/table_fc_car_subsets.xlsx"
wb <- createWorkbook()
...
o.pl = ggdraw() +
  cowplot::draw_image(
    "publication/figures_main/fig_01_overview.PNG", scale = .855)

ggsave2(
  "publication/figures_main/fig_01.png",
  plot_grid(
    plot_grid(
...
ggsave2(
  "publication/figures_main/fig_01.pdf",
  plot_grid(
    plot_grid(
      o.pl + theme(plot.margin = unit(c(0,0,28,-30), "pt")),
      swim_segments, NULL,
