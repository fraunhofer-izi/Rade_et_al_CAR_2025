...
ref.features = paste0(manifest$base$homes, "data/feature_reference_b2.csv")
out.dir = paste0(manifest$base$workdata, "cohorts/ukl_batch_2/cellranger/")
