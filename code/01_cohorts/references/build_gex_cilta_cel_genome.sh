...
# Genome metadata
genome="GRCh38-CiltaCel"
version="2023_8"

# Set up source and build directories
build="build_GRCh38-CiltaCel_2023_8"
mkdir -p "$build"
...
## Insert CAR sequence into modified fasta and
## corresponding annotations into gtf file
cat cilta_cel.fa >> "$fasta_modified"
cat cilta_cel.gtf >> "$gtf_modified"
...
cellranger mkref --ref-version="$version" --memgb=72 --nthreads=24\
